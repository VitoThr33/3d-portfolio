...
export default class Floor {
    ...
    setCircles() {
        ...
        const material = new THREE.MeshStandardMaterial({ color: 0xb92f0c });
        const material2 = new THREE.MeshStandardMaterial({ color: 0x102769 });
        const material3 = new THREE.MeshStandardMaterial({ color: 0x0c422c });
